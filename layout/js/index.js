...
Dom.body.addEventListener('click', (e) => {
  ...
  if (targetType) {
    // 获取当前点击的dom索引
    const targetIndex = findTargetDom(Dom[`${targetType}List`], dom)
    ...
    // 设置当前操作的dom
    Dom.HTMLCodeList[targetIndex].style.display = HTMLStatus
    Dom.CSSCodeList[targetIndex].style.display = CSSStatus
  }
})